...
class BAS_Shared_Mongo_Adapter
{
    public static $_mongo = null;
    public static $_collection = null;
    public static $_collectionName = null;
    
    //TODO: Need to read that configuration from config file.
    const DB_SERVER = 'localhost';
    const DB_NAME = 'mfotest';
    const DB_PORT = '27017';
    ...
    /**
     * If decoment is already available, constructor puts full object in $document
     * variable and assigns $id. Otherwise, initiate document with blank array.
     * 
     * @param $document
     */
    ...
    public function __get($name)
    {
        ...
        //TODO: Throw exception in place of returning null.
    ...
    /**
     * Delete the object. Alias of remove method.
     */
    ...
    {
        //TODO: Must be loading DB_SERVER & DB_PORT from Configuration file.
