...
class Blogbass_IndexController extends Zend_Controller_Action
{
    ...
    public function loginAction()
    {
       if(isset($this->loginNamespace->username) && $this->loginNamespace->username) {
           $this->_redirect('/blogbass/index');
       } 
       $this->view->loginForm = new Blogbass_Form_Login();       
       ...
       if($this->getRequest()->getPost()) {        
          ...
          if($username && $password) {                   
             ...
             if($getUser) {    
                ...
                $this->_redirect("/blogbass/index/login/errormessage/$message");   
             }
          }
       }
    }
    ...
    {
       $this->view->signUpForm = new Blogbass_Form_Signup();        
          ...
          if($username && $email && $password) { 
             ...
             $signUp = $this->users->signUp($username,$password,$email);            
                if($signUp) {                
                   ...
                   $this->_redirect("/blogbass/index/signup/successmessage/$message");
                }
             } catch (Exception $e) {
    ...
    {
       $this->view->blogPostForm = new Blogbass_Form_Blogpost();       
    ...
    {
       $this->view->addCommentForm = new Blogbass_Form_Addcomment();       
